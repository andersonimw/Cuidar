...
app.post('/api/ia/perguntar', async (req, res) => {
  try {
    ...
    const prompt = `Você é um assistente de saúde familiar do app VDA+, desenvolvido para famílias brasileiras.
...
server.listen(PORT, () => console.log('VDA+ rodando na porta', PORT));
